...
@Component({
  ...
  template: `
    <div class="dash-page">
      ...
      <div class="dash-welcome">
        <h1 class="dash-welcome__title">Olá, {{ auth.currentUser()?.name }}!</h1>
      ...
      <nav class="dash-nav">
        <a routerLink="/transactions" class="nav-card">
          ...
          <div class="nav-card__body">
            <span class="nav-card__title">Lançamentos</span>
            <span class="nav-card__desc">Receitas e despesas do mês</span>
          </div>
        ...
        <a class="nav-card nav-card--disabled">
          ...
          <div class="nav-card__body">
            <span class="nav-card__title">Cartões</span>
  ...
  styles: [`
    ...
    .nav-card__icon {
      ...
      &--blue   { background: color-mix(in srgb, var(--color-primary) 15%, var(--color-bg-card));   color: var(--color-primary);   }
      &--mint   { background: color-mix(in srgb, var(--color-income) 20%, var(--color-bg-card));    color: var(--color-income);    }
      &--lilac  { background: color-mix(in srgb, var(--color-highlight) 20%, var(--color-bg-card)); color: var(--color-highlight); }
      &--sand   { background: color-mix(in srgb, var(--color-warning) 20%, var(--color-bg-card));   color: var(--color-warning);   }
    }
